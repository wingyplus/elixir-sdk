...
defmodule Dagger.WorkspaceModule do
  ...
  def settings(%__MODULE__{} = workspace_module) do
    query_builder =
      workspace_module.query_builder |> QB.select("settings") |> QB.select_fields(["id"])
...
defimpl JSON.Encoder, for: Dagger.WorkspaceModule do
  def encode(workspace_module, encoder) do
